...
<head>
    ...
    <title>Temukan anjing - Pet Saver</title>
...
<body>
    ...
    <div class="content-area">
        <aside class="sidebar">
  <form method="GET" action="{{ route('anjing.index') }}">
    ...
    <div class="filter-group">
        ...
        <select name="usia" id="usia" onchange="this.form.submit()">
            <option value="">Pilih</option>
            <option value="anak_anjing" {{ request('usia') == 'anak_anjing' ? 'selected' : '' }}>Anak anjing</option>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            customDropdownOptions.forEach(option => {
                option.addEventListener('click', () => {
                    ...
                    // Contoh: panggil fungsi untuk me-render ulang kartu anjing
