...
<head>
    ...
    <title>Temukan hamster - Pet Saver</title>
    ...
    <style>
        ...
        .main-navbar .cat-icon {
            width: 30px; /* Ukuran ikon hamster */
            height: 30px;
            margin-right: 10px;
...
<body>
    ...
    <div class="content-area">
        <aside class="sidebar">
  <form method="GET" action="{{ route('hamster.index') }}">
    ...
    <div class="filter-group">
        ...
        <select name="usia" id="usia" onchange="this.form.submit()">
            <option value="">Pilih</option>
            <option value="anak_hamster" {{ request('usia') == 'anak_hamster' ? 'selected' : '' }}>Anak hamster</option>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            customDropdownOptions.forEach(option => {
                option.addEventListener('click', () => {
                    ...
                    // Contoh: panggil fungsi untuk me-render ulang kartu hamster
